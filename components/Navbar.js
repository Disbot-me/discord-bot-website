         ...
         <div className="flex items-center space-x-4">
            ...
            {session ? (
               ...
               <button
                  ...
                  className="relative flex items-center text-white font-bold bg-blue-600 px-4 py-2 rounded-md hover:bg-blue-500 sm:px-2 sm:py-1 sm:text-xs md:text-sm"
               >
                  <svg
                     xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 24 24"
                     fill="currentColor"
                     className="w-5 h-5 mr-2 sm:w-4 sm:h-4"
                  >
